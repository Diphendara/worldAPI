...
class CityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $cities = $em->getRepository('worldAPIBundle:City')->findAll();
    ...
    {
        $city = new City();
        $form = $this->createForm('worldAPIBundle\Form\CityType', $city);
    ...
    {
        $deleteForm = $this->createDeleteForm($city);
        $editForm = $this->createForm('worldAPIBundle\Form\CityType', $city);
